...
async def async_update_options(hass, config_entry):
    options = {CONF_PRESSURE_UNIT: config_entry.data.get(CONF_PRESSURE_UNIT, DEFAULT_PRESSURE_UNIT), CONF_DISTANCE_UNIT: config_entry.data.get(CONF_DISTANCE_UNIT, DEFAULT_DISTANCE_UNIT)}
